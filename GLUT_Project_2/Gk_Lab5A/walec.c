...
int     OBSERWATOR_ODLEGLOSC = 40;
int OBSERWATOR_OBROT_X = 20;
int OBSERWATOR_OBROT_Y = 20;
int OBSERWATOR_OBROT_Z = 0;
int ilosc = 30;
int geometria = 0;
int swiatlo_wl = 0;
int material_wl = 0;
...
void RysujWalec(double h, double r, int nv, int nh)
{
    ...
    for (int i = 0; i * alfa <= 360; i++) {
        glNormal3f(15 * cos(Convert(i * alfa)), 0, 15 * sin(Convert(i * alfa)));
        glVertex3f(15 * cos(Convert(i * alfa)), 0, 15 * sin(Convert(i * alfa)));
        glVertex3f(15 * cos(Convert(i * alfa)), 4, 15 * sin(Convert(i * alfa)));
        glVertex3f(15 * cos(Convert((i + 1) * alfa)), 0, 15 * sin(Convert((i + 1) * alfa)));
        glVertex3f(15 * cos(Convert((i + 1) * alfa)), 4, 15 * sin(Convert((i + 1) * alfa)));

    }
    for (int i = 0; i * alfa <= 360; i++) {
        glNormal3f((15 + 4 * sqrt(2)) * cos(Convert(i * alfa)), 0, (15 + 4 * sqrt(2)) * sin(Convert(i * alfa)));
        glVertex3f((15 + 4 * sqrt(2)) * cos(Convert(i * alfa)), 0, (15 + 4 * sqrt(2)) * sin(Convert(i * alfa)));
        glVertex3f(15 * cos(Convert(i * alfa)), 0, 15 * sin(Convert(i * alfa)));
        glVertex3f((15 + 4 * sqrt(2)) * cos(Convert((i + 1) * alfa)), 0, (15 + 4 * sqrt(2)) * sin(Convert((i + 1) * alfa)));
        glVertex3f(15 * cos(Convert((i + 1) * alfa)), 0, 15 * sin(Convert((i + 1) * alfa)));
...
{
	if (klawisz == '=')
		ilosc = (ilosc <= 64) ? ilosc + 1 : ilosc;
	else if (klawisz == '-')
		ilosc = (ilosc >= 4) ? ilosc - 1 : ilosc;
	else if (klawisz == 27)
		exit(0);
	else if (klawisz == 'w')
		OBSERWATOR_ODLEGLOSC = (OBSERWATOR_ODLEGLOSC < 200) ? OBSERWATOR_ODLEGLOSC + 1 : OBSERWATOR_ODLEGLOSC;
	else if (klawisz == 'q')
		OBSERWATOR_ODLEGLOSC = (OBSERWATOR_ODLEGLOSC > 20) ? OBSERWATOR_ODLEGLOSC - 1 : OBSERWATOR_ODLEGLOSC;
	else if (klawisz == '1')
		OBSERWATOR_OBROT_X = OBSERWATOR_OBROT_X - 1;
	else if (klawisz == '2')
		OBSERWATOR_OBROT_X = OBSERWATOR_OBROT_X + 1;
	else if (klawisz == '3')
		OBSERWATOR_OBROT_Y = OBSERWATOR_OBROT_Y - 1;
	else if (klawisz == '4')
		OBSERWATOR_OBROT_Y = OBSERWATOR_OBROT_Y + 1;
	else if (klawisz == '[')
		OBSERWATOR_OBROT_Z = OBSERWATOR_OBROT_Z + 1;
	else if (klawisz == ']')
		OBSERWATOR_OBROT_Z = OBSERWATOR_OBROT_Z - 1;
	else if (klawisz == 'a')
		geometria = (geometria + 1) % 2;
	else if (klawisz == 's')
		swiatlo_wl = (swiatlo_wl + 1) % 3;
